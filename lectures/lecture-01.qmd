...
:::: {.columns}
::: {.column width="70%"}
This seminar is here to help you make a successful transition to college by getting you better acquainted with the academic and social environments at Georgia Tech.

Over the semester you will build strategies for academic, social, and professional success, learn to navigate the resources available to you, and explore what it actually means to be a physicist.

This is a highly interactive course. Come ready to participate and to work in small groups.
...
::: {.highlight-box}
Outcome 4 is why we are looking at career data today, and why your résumé is the first thing you will turn in.
:::
...
You picked this major a few weeks ago. Here is where it goes: nationally, about half of B.S. Physics majors are employed one year after graduation, and most of the rest go to graduate school.
...
For all of you right now, a **résumé** is your concern. A CV comes later during graduate school, as publications, talks, and grants accumulate.

For more detail, see the course guide: [Résumé vs. Academic CV](../supplemental/resume-cv.qmd)
...
- Relevant coursework (optional, and useful right now while experience is thin)
- Academic honors: high school honors and scholarships are fair game this year; Dean's List will come later
...
Research experience counts strongly for physics students — faculty advisors, national labs, REUs — and that is where you are headed. In the meantime, **high school jobs, volunteering, and club roles all belong here.** Starting with a nearly empty Experience section is the normal first-year position, not a problem to hide.
...
The fastest way to learn this campus is to walk it. So go walk it — with people you have not met yet.
...
- **Compile the eight photos into a single PDF** and submit it to Canvas.
:::

::: {.highlight-box}
**Due: TBD.** Counts toward your participation and short-assignment credit.
:::
...
Stop by W-204 while I am in and I will get in the photo with you.

::: {.highlight-box}
Stay out of restricted areas, and be considerate of people working and studying. If a space is closed or an event is going on, come back another time.
:::
