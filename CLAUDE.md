...
- Course facts (dates, weights, policies): `course-files/syllabus-latex/gt-1000-syllabus-fall26.tex` is the source of truth for the printed syllabus; the Course Schedule in `index.qmd` is the live schedule and wins if they differ. Keep `course-files/syllabus.qmd` consistent with both.
